...
V2.4 additions:
- Cursor-following spotlight on desktop/fine-pointer devices.
- Hover lift/pop treatment across cards, tabs, buttons, member rows, and major surfaces.
- Full-page animated RGB aurora/light show behind the sidebar.
- Matrix board increased in visibility and contrast.
- Reduced-motion and touch-device fallbacks preserved.
